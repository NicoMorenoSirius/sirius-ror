class WeatherInteraction < ActiveInteraction::Base
  ...
  def execute
    ...
    weather_response = cached_weather.present? ? JSON.parse(cached_weather) : fetch_weather
